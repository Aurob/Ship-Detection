...
weight = 'data/yoloV3_3Kplus.weights'
...
class server:
    ...
    def error(self, conn, e):
        ...
        if isinstance(e, ConnectionAbortedError):
            ...
            self.send(conn, as_bytes(str([{'error': str(e)}, time.time_ns()])))
    ...
    def handle_query(self, data, conn):
        ...
        try:
            ...
            if request_type.startswith("GET"):
            ...
            elif request_type.startswith("POST"):
                ...
                retval = self.process(data, weight)
    ...
    def process(self, data, weight):
        ...
        centers = self.detect(img, width, height, weight)
    ...
    def detect(self, img, width, height, weight):
